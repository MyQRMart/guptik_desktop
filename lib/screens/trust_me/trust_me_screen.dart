                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              trailing: IconButton(
                                ...
                                onPressed: () =>
                                    _deleteChannel(channel['id'].toString()),
                              ),
                            );
                          },
                        ),
                  ...
                  child: Column(
                    children: [
                      ...
                      if (_inviteCode.isNotEmpty)
                        QrImageView(
                          data:
                              _formattedLink, // Updated to use the full link for QR as well
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Clipboard.setData(
                                  ClipboardData(text: _formattedLink),
                                );
